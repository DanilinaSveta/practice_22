...
button.onclick = function (){
    ...
    //расчетные данные
        ...
        document.querySelector(".out5").innerHTML = Clcr.toFixed(3);
        ...
        document.querySelector(".out10").innerHTML = BUN_Cr.toFixed(3);
        document.querySelector(".div11").innerHTML = "U/Cr = ";
        document.querySelector(".out11").innerHTML = U_Cr.toFixed(3);
    }
}